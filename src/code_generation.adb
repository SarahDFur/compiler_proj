...
package body Code_Generation is
   ...
   o_file: File_Type;
   -- TO VM:
   curr_jack_file: File_Type;  -- reads from JACK file
   ...
   begin
      ...
      Close(o_file);
      Create(File => curr_jack_file, Mode => Out_File, Name => Current_Directory & '\' & To_String(name) & ".vm");
      Close(curr_vm_file);
